...
1. **Context Enrichment**  
   LLMs are trained on large general datasets like Common Crawl. They don’t know your business. Left on their own, they’ll hallucinate. Tools such as Retrieval-Augmented Generation (RAG) systems let you connect your private databases so agents are grounded in your data and context.  
...
>  
> As models improve, **context engineering** has become critical. The quality of information you provide an agent largely determines the quality of its output. Context can come from prompts, short-term "memory", databases, or tools like search and RAG.  
>  
...
- **Autonomy / Control** Without guardrails, agents can run away.  
