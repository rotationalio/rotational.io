...
Please visit our website at https://ourshinypet.netlify.app/ for more details on the main application.
...
Besides `Tidyverse`, we will use `ggplot2`, `skimr`, `naniar`, and `cld3` for data preparation.

```{r, message = FALSE}
packages = c('tidyverse', 'ggplot2', 'skimr', 'naniar', 'cld3', 'plotly')
...
packages = c('tidyverse', 'tidymodels', 'ggstatsplot', 'ggplot2', 'plotly',
             ...
             'reshape2', 'tictoc', 'tidytext', 'visNetwork', 'rattle', 'sparkline')
